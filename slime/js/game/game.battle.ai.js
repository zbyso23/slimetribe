...
Game.Battle.Ai = {
    ...
    turnStep: function() {
	Game.Battle.Ai.grid.clearGrid( BATTLE_GRID[ gameData.battle.selection.player ] );
    ...
    spells: function( monsters ) {
        try {
            ...
            Game.Battle.Ai.grid.select( { x: cords1[0], y: cords1[1] } );
	    gameData.battle.selection.selected = true;
	    gameData.battle.selection.x = cords1[0];
	    gameData.battle.selection.y = cords1[1];
	    gameData.battle.gui.cords = cords2;
	...
	try {
	    ...
	    var cords2 = enemy.monster['cords'];
            Game.Battle.Ai.grid.select( { x: cords1[0], y: cords1[1] } );
	    Game.Battle.Ai.grid.showGrid( BATTLE_GRID.enemy, { x: cords2[0], y: cords2[1] } );
		...
		Game.Battle.Ai.grid.showGridPath( BATTLE_GRID.enemy, gameData.battle.selection.path );
	    }
	...
	try {
	    ...
	    Game.Battle.Ai.grid.showGrid( BATTLE_GRID.free, { x: cords1[0], y: cords1[1] } );
	    Game.Battle.Ai.grid.showGridPath( BATTLE_GRID.free, gameData.battle.selection.path );
	    torch.position.x = monstersModels[gameData.battle.selection.x][gameData.battle.selection.y].root.position.x;
	    torch.position.z = monstersModels[gameData.battle.selection.x][gameData.battle.selection.y].root.position.z;
